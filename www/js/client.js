...
let recStartTime;
let recElapsedTime;
let HangainTheme = 'neon'; // neon - dark - forest - ghost ...
...
function getHtmlElementsById() {
    ...
    themeSelect = getId('HangainTheme');
...
function welcomeUser() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            let message = {
                email: '',
                subject: 'Please join our Hangain Video Chat Meeting',
        ...
        event.channel.onmessage = (msg) => {
            switch (event.channel.label) {
                case 'Hangain_chat_channel':
                    ...
                    break;
                case 'Hangain_file_sharing_channel':
                    try {
...
/**
 * Set Hangain theme neon | dark | forest | sky | ghost | ...
 * @param {*} theme
 */
...
function setRecordButtonUi() {
    ...
    if (HangainTheme == 'ghost') recordStreamBtn.style.setProperty('background-color', 'transparent');
}
...
function createChatDataChannel(peer_id) {
    chatDataChannels[peer_id] = peerConnections[peer_id].createDataChannel('Hangain_chat_channel');
...
function createFileSharingDataChannel(peer_id) {
    fileDataChannels[peer_id] = peerConnections[peer_id].createDataChannel('Hangain_file_sharing_channel');
    ...
    if (isImageURL(incomingFileInfo.fileName)) {
        ...
        reader.onload = (e) => {
            Swal.fire({
                ...
                imageAlt: 'Hangain-file-img-download',
                showDenyButton: true,
        ...
        Swal.fire({
            allowOutsideClick: false,
            background: swalBackground,
            imageAlt: 'Hangain-file-download',
            imageUrl: fileSharingImg,
            position: 'center',
            title: 'Received file',
            text: incomingFileInfo.fileName + ' size ' + bytesToSize(incomingFileInfo.fileSize),
...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong> Made with ❤️ By JS</strong>',
        html: `
        <br/>
        <div id="about">
            <b>Open Source</b> project on
            <a href="https://github.com/hangain/Hangain" target="_blank"><br/></br>
            <img alt="Hangain github" src="../images/github.png"></a><br/><br/>
           
            <br /><br />
            Author:<a href="" target="_blank"> Jahanvi Sharma & Shubham Kumar Singh</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
